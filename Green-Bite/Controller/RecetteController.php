...
final class RecetteController
{
    ...
    public function handleFrontPost(): ?string
    {
        ...
        // Green-Bite : session user stockée dans $_SESSION['user']['id']
        ...
        if ($action === 'create') {
            ...
            $this->attachIngredientIfProvided($recetteId, $v['data'], $idUser ?: null, false);
            $_SESSION['recette_flash'] = 'Recette ajoutée avec succès.';
            return 'redirect';
        }
        ...
        if ($action === 'update') {
            ...
            $this->attachIngredientIfProvided($id, $v['data'], $idUser ?: null, true);
            $_SESSION['recette_flash'] = 'Recette mise à jour.';
            return 'redirect';
        }
