...
<?php $activePage = 'orders'; include __DIR__ . '/../includes/sidebar_admin.php'; ?>
    <div class="dashboard-main">
        <header class="dashboard-header">
            <div class="header-title"><?= $isEdit ? '✏️ Modifier' : '➕ Ajouter' ?> une commande</div>
            <div class="header-right">
                <span class="header-badge">🟢 En ligne</span>
                <?php $u = getCurrentUser(); $ini = strtoupper(mb_substr($u['prenom']??'',0,1).mb_substr($u['nom']??'',0,1))?:'AD'; ?>
                <div class="admin-avatar"><?= h($ini) ?></div>
            </div>
        </header>
        <div class="page-content">
            <div class="page-header">
                <h1><?= $isEdit ? 'Modifier' : 'Ajouter' ?> une commande</h1>
                <p>Tous les attributs de la classe Commande sont disponibles.</p>
            </div>
