...
<body>
  ...
  <nav class="navbar">
    ...
    <div class="navbar-right">
      <a class="primary-btn" style="padding:9px 20px;font-size:0.85rem;text-decoration:none;display:inline-block;" href="../admin/recettes.php">Espace admin</a>
    ...
    <div class="form-modal" style="max-width:640px;">
      ...
      <form id="frontRecetteForm" method="post" action="<?= hf($formAction) ?>" novalidate>
        ...
        <div class="form-group">
          ...
          <?php if (isset($formErrors['nom'])): ?><div class="field-error"><?= hf($formErrors['nom']) ?></div><?php endif; ?>
        </div>
        <div class="form-group">
          ...
          <?php if (isset($formErrors['calories'])): ?><div class="field-error"><?= hf($formErrors['calories']) ?></div><?php endif; ?>
        </div>
        <div class="form-group">
          ...
          <?php if (isset($formErrors['description'])): ?><div class="field-error"><?= hf($formErrors['description']) ?></div><?php endif; ?>
        </div>
