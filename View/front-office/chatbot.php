...
// Utiliser l'utilisateur connecté depuis la session
$id_utilisateur = getLoggedUserId() ?: 1;
...
<body>
    ...
    <script>
        ...
        const apiBase = '/Green-Bite/api/chatbot';
        ...
        function viewProductDetails(productId, productName) {
            ...
            window.open(`/Green-Bite/View/front-office/product.php?id=${productId}`, '_blank');
        }
        ...
        async function confirmAddToCart(productId, productName, productPrice) {
            ...
            try {
                ...
                const response = await fetch(`/Green-Bite/api/product.php?id=${productId}`);
                const data = await response.json();
