...
<div class="main-container" style="padding-top:1.5rem;">
    ...
    <div id="historiqueTab" class="tab-content">
        ...
        <!-- Contenu de l'historique (chargé automatiquement depuis la session) -->
...
async function loadOrderHistory() {
    try {
        ...
        // Récupérer les données via l'API (l'utilisateur est identifié par la session)
        const response = await fetch('../../api/orders/history.php');
