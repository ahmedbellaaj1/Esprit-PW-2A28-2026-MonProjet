...
<div class="dashboard-layout">
  <aside class="sidebar">
    <div class="sidebar-logo">
      <img src="/Green-Bite/View/assets/659943731_2229435644263567_1175829106494475277_n.png" alt="GreenBite" class="sidebar-logo-img"/>
      Green<span>Bite</span>
    </div>
    <div class="sidebar-role">Administration</div>
    <nav class="sidebar-nav">
      <a class="sidebar-link" href="/Green-Bite/View/back-office/dashboard.php">
        <span class="icon">📊</span> Vue d'ensemble
      </a>
      <a class="sidebar-link" href="/Green-Bite/View/back-office/products.php">
        <span class="icon">🛒</span> Produits
      </a>
      <a class="sidebar-link" href="/Green-Bite/View/back-office/reviews_moderation.php">
        <span class="icon">⭐</span> Évaluations
      </a>
      <a class="sidebar-link" href="/Green-Bite/View/back-office/users.php">
        <span class="icon">👥</span> Utilisateurs
      </a>
      <a class="sidebar-link active" href="/Green-Bite/View/back-office/recettes.php">
        <span class="icon">🍽️</span> Recettes
      </a>
      <a class="sidebar-link" href="/Green-Bite/View/back-office/orders.php">
        <span class="icon">📦</span> Commandes
      </a>
    </nav>
    <div class="sidebar-bottom">
      <a class="sidebar-link" href="/Green-Bite/View/front-office/recettes.php">
...
<script src="/Green-Bite/View/assets/recettes-admin.js?v=<?= time() ?>" defer></script>
</body>
</html>
