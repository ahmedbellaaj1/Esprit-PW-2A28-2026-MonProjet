...
/** @var string $formAction Chemin URL du script qui traite le POST (ex. /projet/View/admin/recettes.php) */
...
<div class="dashboard-layout">
  ...
  <div class="dashboard-main">
    <header class="dashboard-header">
      <div class="header-title">Module Recettes durables – Back-office</div>
      <div class="header-right">
        <span class="header-badge">🟢 CRUD Recette</span>
    ...
    <div class="page-content">
      <div class="page-header">
        ...
        <p>Ajoutez, modifiez ou supprimez des recettes (entité <strong>recette</strong>) – validation côté serveur et formulaire.</p>
      </div>
      ...
      <div class="metrics-grid">
        ...
        <div class="metric-card">
          ...
          <div class="metric-label">Tables liées (schéma)</div>
          <div class="metric-trend trend-down">Ingrédients : autre module</div>
        </div>
      </div>
  ...
  <div class="form-modal" style="max-width:640px;">
    ...
    <form id="recetteForm" method="post" action="<?= h($formAction) ?>" novalidate>
      ...
      <div class="form-group">
        ...
        <?php if (isset($formErrors['calories'])): ?><div class="field-error"><?= h($formErrors['calories']) ?></div><?php endif; ?>
      </div>
      <div class="form-group">
        ...
        <?php if (isset($formErrors['description'])): ?><div class="field-error"><?= h($formErrors['description']) ?></div><?php endif; ?>
      </div>
