...
// Configuration du chemin - Green-Bite
const API_DONS = '/Green-Bite/Model/DonApi.php';
const API_PARTENAIRES = '/Green-Bite/Model/PartenaireApi.php';
...
try {
    ...
    const res = await fetch(`${API_DONS}?action=verify-image`, {
        method: 'POST',
        body: formData
    });
    ...
    setAIBadge(ctx, 'error', 'Erreur de communication avec le serveur.');
}
}
