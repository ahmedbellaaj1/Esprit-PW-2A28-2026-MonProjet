...
<<<<<<< HEAD
        // Obtenir les recommandations (avec personnalisation selon le profil si dispo)
        $recommendations = $this->chatbot->getRecommendations($message_text, $id_message, 5, $id_utilisateur);
=======
