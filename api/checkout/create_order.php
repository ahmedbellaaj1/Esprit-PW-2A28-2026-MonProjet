...
try {
    ...
    if (!isset($_SESSION['user']['id'])) {
        ...
        echo json_encode(['ok' => false, 'error' => 'Vous devez être connecté pour passer une commande.']);
        exit;
    }
    ...
    if (!$id_produit || !$quantite || $quantite <= 0 || !$prix_total || $prix_total <= 0) {
        http_response_code(400);
        echo json_encode(['ok' => false, 'error' => 'Données invalides (id_produit, quantite, prix_total requis)']);
        exit;
    }
