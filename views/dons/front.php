...
$baseUrl = '/' . basename(dirname(__DIR__, 2)) . '/views';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<body>
  ...
  <nav class="navbar">
   <a class="navbar-logo" href="../front_office.html"><img src="<?= $baseUrl ?>/assets/images/logo.png" alt="GreenBite" style="height:80px;width:auto;object-fit:contain;vertical-align:middle;"/></a>
  ...
  <section class="hero-section">
    ...
    <div class="search-wrapper">
      ...
      <button onclick="openFrontCreateDonModal()" style="background:#0f766e;color:#fff;border:none;border-radius:9999px;padding:0.65rem 1rem;cursor:pointer;font-weight:600;">
        + Publier un don
      </button>
    </div>
  </section>
  ...
  <div class="main-container">
    ...
    <!-- SECTION MEILLEURS PARTENAIRES -->
    <div class="section-heading" style="margin-top:2rem;margin-bottom:1rem;">
      🏆 Meilleurs partenaires (par nombre de dons)
    </div>
    <div id="top-partenaires-container" style="margin-bottom:2rem;">
      <div style="text-align:center;padding:1rem;color:#94a3b8;">Chargement des meilleurs partenaires...</div>
    </div>
  ...
  <div class="form-modal-overlay" id="frontDonCreateModal">
    <div class="form-modal" style="max-width:620px;">
      ...
      <div style="margin-bottom:1rem;">
        ...
        <button type="button" onclick="frontAddProduitLine()"
