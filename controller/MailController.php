...
class MailController {
    ...
    public function sendConfirmationEmail($user, $event, $participation_id, $qr_token = null) {
        ...
        if ($qr_token === null) {
            ...
            $sql = "UPDATE participation SET code_qr = :code_qr WHERE id = :id";
        ...
        // Lien de validation du QR code
        $qrLink = $baseUrl . "/projetwebnova1/view/front/valider-presence.php?token=" . $qr_token . "&id=" . $participation_id;
    ...
    /**
     * Générer un QR code sous forme d'image (HTML simple)
     */
    public function generateQRCodeHTML($token, $participation_id) {
        $baseUrl = $this->getBaseUrl();
        $qrContent = $baseUrl . "/projetwebnova1/view/front/valider-presence.php?token=" . $token . "&id=" . $participation_id;
        
        // Créer une URL vers l'API QR code
            ...
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div style="text-align: center;">
                        <a href="' . $baseUrl . '/projetwebnova1/view/front/showEvenement.php?id=' . $event['id'] . '" class="btn">📋 Voir l\'événement</a>
                    </div>
                </div>
                <div class="footer">
                    <p>GreenBite - Plateforme événementielle éco-responsable</p>
